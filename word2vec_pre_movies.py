...
filename = "/Users/mac/Library/Mobile Documents/com~apple~CloudDocs/movies2.csv"
outputfilepath = "/Users/mac/Desktop/movie/"
...
with open(filename, 'r') as f:
    ...
    for row in reader:
        if row[0] != lastID:#新的电影就新建文件
            file_name = outputfilepath + row[0] + '.txt'#新建文件
            lastID = row[0]
