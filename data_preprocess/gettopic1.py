...
if __name__=='__main__':
    ...
    inputfile = os.path.join(root_path,'movie_storyline_comment_topic_new_small.csv')
    inputfile_new = os.path.join(root_path,'movie_storyline_comment_topic_new_small_new.csv')
